...
public class DataUtil {
    private static final List<User> USERS = Arrays.asList(
            new User(1, "MikeMirzayanov", "Mike Mirzayanov", User.Colors.RED),
            new User(6, "pashka", "Pavel Mavrin", User.Colors.GREEN),
            new User(9, "geranazavr555", "Georgiy Nazarov", User.Colors.BLUE),
            new User(11, "tourist", "Gennady Korotkevich", User.Colors.GREEN)
    );
