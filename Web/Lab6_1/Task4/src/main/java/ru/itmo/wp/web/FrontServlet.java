...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        if(!executeMethod(before, page, request, response, view)
            || !executeMethod(method, page, request, response, view)
            || !executeMethod(after, page, request, response, view)
        )
            return;
    ...
    private boolean executeMethod(Method method, Object page, HttpServletRequest request, HttpServletResponse response, Map<String, Object> view)
