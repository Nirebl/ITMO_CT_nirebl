...
public class EventRepositoryImpl implements EventRepository {
    ...
    public List<Event> getAll() {
        ...
        try (Connection connection = DATA_SOURCE.getConnection()) {
            ...
            throw new RepositoryException("Can't find Events.", e);
        }
        return events;
    }
    ...
    public List<Event> getUserEvents(long userId) {
        List<Event> events = new ArrayList<>();
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement("SELECT * FROM 'Event' Where userId=? ORDER BY id DESC")) {
            ...
            throw new RepositoryException("Can't find Event for User.", e);
        }
        return events;
    }
