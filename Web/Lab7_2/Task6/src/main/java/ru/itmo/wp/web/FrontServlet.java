...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route,
        ...
        if (!executeMethod(before, page, request, response, view, json)
                || !executeMethod(method, page, request, response, view, json)
                || !executeMethod(after, page, request, response, view, json)
        )
            return;
    ...
    private boolean executeMethod(
            Method method, Object page, HttpServletRequest request,
            HttpServletResponse response, Map<String, Object> view, boolean json)
            throws ServletException, IOException, RedirectException {
        try {
    ...
    private Method findMethod(Class<?> pageClass, String action) {
        Method method = null;
